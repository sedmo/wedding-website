    ...
    <section className="pt-24 pb-20 md:pb-32 px-4 bg-background">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative rounded-2xl overflow-hidden mb-16 h-64 md:h-80">
          <img
            src="https://images.unsplash.com/photo-1505881502353-a1986add3762?w=1400&h=600&fit=crop"
            alt="Tropical engagement"
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end justify-center pb-10">
            <div className="text-center text-white">
              <Gift weight="fill" className="w-10 h-10 mx-auto mb-3" />
        ...
        <div className="mt-16 grid grid-cols-3 gap-4">
          <img
            src="https://images.unsplash.com/photo-1468413253725-0d5181091126?w=400&h=300&fit=crop"
            alt="Jamaica engagement"
            className="rounded-xl object-cover aspect-[4/3] w-full"
          />
          <img
            src="https://images.unsplash.com/photo-1501426026826-31c667bdf23d?w=400&h=300&fit=crop"
            alt="Jamaica engagement"
            className="rounded-xl object-cover aspect-[4/3] w-full"
          />
          <img
            src="https://images.unsplash.com/photo-1516585427167-9f4af9627e6c?w=400&h=300&fit=crop"
            alt="Jamaica engagement"
            className="rounded-xl object-cover aspect-[4/3] w-full"
          />
        </div>
